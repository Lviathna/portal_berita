...
@section('title', 'PEI | Portal Berita')
  ...
  <!-- swiper -->
    ...
    <div class="flex flex-col px-4 md:px-10 lg:px-14 mt-10">
      <div class="flex flex-col md:flex-row justify-between items-center w-full mb-6">
        ...
        {{-- <a href="{{ route('filament.user.auth.login') }}" class="bg-primary px-5 py-2 rounded-full text-white font-semibold mt-4 md:mt-0 h-fit">
